...
$(() => {
    if (window.location.search) {
        ...
        if (window.location.search.substr(0, window.location.search.lastIndexOf("=")).substr(1) == "search") {
            ...
            if (sFilter == "sale") {
                $("#btnFixedPriceFilter").css("background", "#C82B51").css("color", "#FFF");
                searchSellingType = "Fixed Sale";
            } else if (sFilter == "auction") {
                $("#btnAuctionFilter").css("background", "#C82B51").css("color", "#FFF");
...
$("#btnFixedPriceFilter").on('click', () => {
    ...
    toggleControls(true);
    $("#btnFixedPriceFilter").css("background", "#C82B51").css("color", "#FFF");
    $("#btnAuctionFilter").css("background", "").css("color", "");
...
$("#btnAuctionFilter").on('click', () => {
    ...
    toggleControls(true);
    $("#btnAuctionFilter").css("background", "#C82B51").css("color", "#FFF");
    $("#btnFixedPriceFilter").css("background", "").css("color", "");
