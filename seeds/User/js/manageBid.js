                ...
                for (let nData = 0; nData < result.data.data.length; nData++) {
                    ...
                    if (result.data.data[nData].eBidStatus == 'Bid') {
                        if (result.data.data[nData].sTransactionStatus === 0)
                            bidStatusLabel = '<span class="bid-status pending ml-auto font-family-bs-medium font-size-16 text-color-pending"> <i title="Waiting To Be Mined" class="fa fa-clock-o" > </i> Pending</span>'
                        ...
                        if (result.data.data[nData].sTransactionStatus === 0)
                            bidStatusLabel = '<span class="bid-status pending ml-auto font-family-bs-medium font-size-16 text-color-cancelled"> <i title="Waiting To Be Mined" class="fa fa-clock-o" > </i> Canceled</span>'
                        else if (result.data.data[nData].sTransactionStatus === 1)
                        ...
                        if (result.data.data[nData].sTransactionStatus === 0)
                            bidStatusLabel = '<span class="bid-status pending ml-auto font-family-bs-medium font-size-16 text-color-accepted"> <i title="Waiting To Be Mined" class="fa fa-clock-o" > </i> Accepted</span>'
                        else if (result.data.data[nData].sTransactionStatus === 1)
                        ...
                        if (result.data.data[nData].sTransactionStatus === 0)
                            bidStatusLabel = '<span class="bid-status pending ml-auto font-family-bs-medium font-size-16 text-color-cancelled"> <i title="Waiting To Be Mined" class="fa fa-clock-o" > </i> Rejected</span>'
                        else if (result.data.data[nData].sTransactionStatus === 1)
